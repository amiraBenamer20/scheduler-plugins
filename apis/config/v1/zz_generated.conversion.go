...
import (
	...
	config "github.com/amiraBenamer20/scheduler-plugins/apis/config"
)
...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*config.NetworkCostArgs)(nil), (*NetworkCostArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NetworkCostArgs_To_v1_NetworkCostArgs(a.(*config.NetworkCostArgs), b.(*NetworkCostArgs), scope)
	}); err != nil {
		return err
	}
	...
	//Amira
	if err := s.AddGeneratedConversionFunc((*TopologicalcnSortArgs)(nil), (*config.TopologicalcnSortArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_TopologicalSortArgs_To_config_TopologicalcnSortArgs(a.(*TopologicalcnSortArgs), b.(*config.TopologicalcnSortArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.TopologicalcnSortArgs)(nil), (*TopologicalcnSortArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_TopologicalcnSortArgs_To_v1_TopologicalcnSortArgs(a.(*config.TopologicalcnSortArgs), b.(*TopologicalcnSortArgs), scope)
	}); err != nil {
		return err
	}
...
// Convert_config_NetworkCostArgs_To_v1_NetworkCostArgs is an autogenerated conversion function.
func Convert_config_NetworkCostArgs_To_v1_NetworkCostArgs(in *config.NetworkCostArgs, out *NetworkCostArgs, s conversion.Scope) error {
	return autoConvert_config_NetworkCostArgs_To_v1_NetworkCostArgs(in, out, s)
}
...
// Convert_v1_TopologicalSortArgs_To_config_TopologicalSortArgs is an autogenerated conversion function.
func Convert_v1_TopologicalSortArgs_To_config_TopologicalcnSortArgs(in *TopologicalcnSortArgs, out *config.TopologicalcnSortArgs, s conversion.Scope) error {
	return autoConvert_v1_TopologicalcnSortArgs_To_config_TopologicalcnSortArgs(in, out, s)
}
